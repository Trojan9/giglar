...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setIsError(true);
      setFormStatus('Unable to send message. Please make sure the server is running or contact us directly at godwin@giglarconcept.com');
    } finally {
        ...
        <div className="contact-content">
          <div className="contact-info">
            ...
            <div className="info-item">
              ...
              <span>godwin@giglarconcept.com</span>
            </div>
          </div>
